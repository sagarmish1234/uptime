...
import UpdateMonitor from '@/components/updatemonitor/UpdateMonitor';
    ...
    <div>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => setSheetState(true)}>
      ...
      <UpdateMonitor
        monitor={monitor}
        openSheet={sheetState}
        controlOpen={setSheetState}
      ></UpdateMonitor>
    </div>
  );
};
